...
@proof_gap Run the real browser golden vector and prove installed artifacts without workspace source fallback. Wire and prove production PM2 receiver, durable bootstrap, trusted prompt, and CAR CLI compositions before advertising the four entrypoints as fully capable rather than structurally emitted.
