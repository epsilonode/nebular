...
@projects Current default projects are `configuration`, `kernel`, `restore`, and `seam`; `live` is opt-in. New Broker domains receive named projects before their adapters land rather than joining a generic catch-all.
