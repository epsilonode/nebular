...
@gate Laws are part of ordinary `mise run test`, compile-negative fixtures are part of typecheck, and browser/runtime cross-environment laws remain focused conformance tasks included by final verification.
